  ...
  Future<void> toggleFollow(String me, String them) async {
    ...
    try {
      await db.runTransaction((txn) async {
        ...
        final followingField = countKey(following);
        final followersField = countKey(followers);
        ...
        if (edgeSnap.exists) {
          ...
          txn
            ...
            ..update(meRef, {followingField: meFollowing + 1})
            ..update(themRef, {followersField: themFollowers + 1});
        }
      });
    } catch (e, s) {
