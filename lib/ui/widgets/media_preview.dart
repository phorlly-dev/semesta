...
class MediaPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (assets.length == 1) {
      ...
      return _buildMultiple(context, x: 46);
    } else {
  ...
  Widget _buildSingle(BuildContext context) {
    ...
    return Padding(
      padding: const EdgeInsets.only(left: 64, top: 8, right: 12),
      child: ClipRRect(
  ...
  Widget _buildMultiple(BuildContext context, {double x = 16}) {
    return SizedBox(
      height: 210,
      child: ListView.separated(
        padding: EdgeInsets.symmetric(horizontal: x, vertical: 8),
